...
public class CardManager {
	...
	static {
		CARDS.put("Archers", new TroopCard("Archers", CardRarity.COMMON, 3, 304, 112, 0.9, 1, 10, 2));
		CARDS.put("Baby Dragon", new TroopCard("Baby Dragon", CardRarity.RARE, 4, 1152, 161, 1.5, 1, 15, 3));
		CARDS.put("Barbarians", new TroopCard("Barbarians", CardRarity.COMMON, 5, 670, 192, 1.3, 1, 20, 4));
		...
		CARDS.put("Mini P.E.K.K.A", new TroopCard("Mini P.E.K.K.A", CardRarity.RARE, 4, 1433, 755, 1.6, 0.1, 25, 6));
		CARDS.put("Elixir Collector", new BuildingCard("Elixir Collector", CardRarity.RARE, 6, 1164, 30.0));
		CARDS.put("Golem", new TroopCard("Golem", CardRarity.EPIC, 8, 5120, 312, 2.5, 0.2, 40, 7));
	}
