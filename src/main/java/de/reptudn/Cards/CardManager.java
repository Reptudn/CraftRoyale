...
public class CardManager {
	...
	static {
		CARDS.put("Archers", new TroopCard("Archers", CardRarity.COMMON, 3, 304, 112, 0.9, 0.3, 10, 3));
		CARDS.put("Baby Dragon", new TroopCard("Baby Dragon", CardRarity.RARE, 4, 1152, 161, 1.5, 0.3, 15, 3));
		CARDS.put("Barbarians", new TroopCard("Barbarians", CardRarity.COMMON, 5, 670, 192, 1.3, 0.3, 20, 1));
		...
		CARDS.put("Mini P.E.K.K.A", new TroopCard("Mini P.E.K.K.A", CardRarity.RARE, 4, 1433, 755, 1.6, 0.25, 25, 1));
		CARDS.put("Elixir Collector", new BuildingCard("Elixir Collector", CardRarity.RARE, 6, 1164, 30.0));
		CARDS.put("Golem", new TroopCard("Golem", CardRarity.EPIC, 8, 5120, 312, 2.5, 0.1, 40, 1));
	}
